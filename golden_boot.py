...
# 'Страна (Кол-во золотых бутс, Кол-во футболистов-обладателей)'
create_geo_map_image(df, 'Победы', [
    {'text': 'Обладатели<br>Золотой Бутсы<br>по Странам:<br>Европа',
        'lat': 60, 'lon': 40},
    {'text': 'Обладатели<br>Золотой Бутсы<br>по Странам:<br>Америка',
        'lat': -50, 'lon': 10},
    {'text': 'Страна<br>(Кол-во золотых бутс,<br>Кол-во футболистов-обладателей)',
     'lat': 60, 'lon': -20, 'size': 15, 'weight': 'normal'},
    {'text': 'Страна<br>(Кол-во золотых бутс,<br>Кол-во футболистов-обладателей)',
     'lat': -50, 'lon': -140, 'size': 15, 'weight': 'normal'},
])
